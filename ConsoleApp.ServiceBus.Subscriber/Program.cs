...
namespace ConsoleApp.ServiceBus.Subscriber
{
    internal class Program
    {
        ...
        private static async Task ProcessMessagesAsync(Message message, CancellationToken
        token)
        {
            // Process the message.
        ...
        private static Task ExceptionReceivedHandler(ExceptionReceivedEventArgs
